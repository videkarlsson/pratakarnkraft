...
<p>Vi vill först med tydlighet säga att vi delar oron över att kärnkraft idag är för dyrt för att på allvar globalt kunna konkurrera ut billig kol, gas, och olja. Runt om i världen ser vi som en konsekvens forfarande betydande nyinvesteringar i fossila bränslen. Att i detta läge utvärdera samtliga kostnader hos de olika koldioxidsnåla alternativen tror vi är helt rätt. Först då kan vi se vad vi behöver jobba med för att göra dem mer konkurrenkraftiga</p>
<p>Vi tycker därför att det är bra att man försöker belysa helhetskostanderna för kärnkraft. Det blir dock problematiskt när man överdriver vissa kostnader för kärnkraft och samtidigt blundar för stora delar av kostnaderna hos de förnybara energislagen.</p> 
<H3>En granskning av vind-, vatten- och kärnkrafts kostnader - i fyra punkter</H3>
<p>I fyra punkter granskar vi kostnaderna för olika energislag och bemöter påståendet att kärnkraft skulle vara ett dyrare alternativ än de förnybara energislagen.</p>
<H4>1. Dagslägets skatter subventioner och avgifter</H4>
...
<p><b>Vi tycker att det är värt att fråga sig, varför vindkraften skulle behöva en subvention som motsvarar ca en tredjedel av dess intäkter, om det är det billigaste kraftslaget?</b></p>
<p class="fact-check-text"><i class="fa fa-arrow-circle-o-right read-more-arrow"></i> Läs mer: Här finner du den beräkningen som ligger bakom diagrammet ovan</p>  
<H4>2. Kärnkraftens dolda kostnader</H4>
<p>Ett vanligt argument mot kärnkraft är att den åtnjuter "dolda" subventioner. Det som då avses är kostnader för en olycka och kostnaderna för att ta hand om reaktor och avfall efter att de tjänat ut. Sällan görs dock några försök att sätta ett pris på dessa kostnader. Detta tycker vi är problematiskt för det är först med ett pris vi kan se hur stora kostnaderna är och diskutera om och i så fall vad vi ska göra åt dem.</p>
<H4>Kostnaderna för en allvarlig olycka -<br>eller varför effektskatten är en väl tilltagen olycksfallsförsäkring</H4>
<p>Enligt beräkningar som vi inom Miljöpartiet ställt oss bakom så skulle kostnaderna för Tjernobyl respektive Fukushima uppgå till 1000 miljarder kronor vardera.<p>
<p><i class="fa fa-rocket fa-5x" id="rocket"></i>Är inte 1000 miljarder kronor en astronomisk summa?</p>  
...
<p><i class="fa fa-bolt fa-5x" id="bolt" style="float:left"></i><b> Men för att beräkna vad som är en rimlig olycksfallsförsäkring behöver vi ställa denna kostnad i proportion till hur mycket el kärnkraften producerat i världen<b></p>
TODO Move and set bolt = mängden producerad ström i TWH

MEN vi har fler skäl att mena att försäkringsargumentet inte håller läs mer om detta här....

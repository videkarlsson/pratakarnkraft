...
<H3>Vår kritik mot miljöpartiets beräkningar - i fyra punkter</H3>
<p>I fyra punkter bemöter vi här påståendet att kärnkraft skulle vara ett dyrare alternativ än de förnybara energislagen.</p>
...
<p><b class="fact-check-text"><i class="fa fa-arrow-circle-o-right read-more-arrow"></i> Här finner du den beräkningen som ligger bakom diagrammet ovan</b></p>  
<H4>Varför </H4>
<p>Ett vanligt argument mot kärnkraft är att den åtnjuter "dolda" subventioner. Vi har titt</p>
<H5>Effektskatten en </H5>
<H5>Räcker pengarna i Kärnavfallsfonden?</H5>
<H4>3. Väderberoende energikällor har dolda kostnader</H4>

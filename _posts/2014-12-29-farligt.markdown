...
Att användandet av kärnkraft kan leda till att radioaktivt material på något sätt sprids i vår omgivning är ett av de vanligaste argumenten mot kärnkraft. Radioaktivitet skrämmer de flesta av oss. Att vi varken kan se eller lukta radioaktivitet gör det svårt för oss att skapa en bild av hur stråldoserna från kärnkraft (både vid normal drift och olyckor) förhåller sig till de strålkällor vi utsätter oss för normalt och inte skräms av. Enheterna som används för att mäta strålning är därtill relativt okända för de flesta vilket gör jämförelse än svårare. För att illustrera det har vi här lånat XKCDs sammanställning av olika stråldoser.
...
Vi tror att denna övergripande förståelse för olika stråldoser är nödvändiga för att vi ska kunna ta rationella beslut när vi väger riskerna med kärnkraft mot riskerna med fortsatt användande av fosila bränslen. 
Till skillnad från klimathotet kan rädslan för en kärnkraftsolycka undröjas genom den enkla lokala åtgärden att stänga närliggande kärnkraftverk. Vi tror att detta kan vara en av förklaringarna till att t.ex. Tyskland har valt att prioritera utfasning av kärnkraftverk före kol fast både hälsoeffekterna och de globala miljö-effekterna av fortsatt kolanvändande lång överskrider de av kärnkraft.

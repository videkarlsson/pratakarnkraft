...
<ul>
	...
	<a class="page-scroll" href="#danger-3"><li><p><b class="fact-check-text">Risker vid transport av bränsle och avfall</b><br>I detta avsnitt redogör vi för risker förenade med transport av bränsla och avfall</p></li></a>
 	...
 	<a class="page-scroll" href="#danger-4"><li><p><b class="fact-check-text">Hur många liv har kärnkraft räddat?</b><br>Kärnkraft har visat sig vara ett mycket effektivt sätt att ersätta fosil-energiproduktion. Eftersom fosila bränslen är förenade med mycket stort antal dösfall per producerad kWh är det en relevant fråga hur många människor som hade dött ifall vi inte byggt de reaktorer vi har idag.</p></li></a>
...
<section id="danger-3">
	...
	Miljö och hälsoeffekterna av en olycka vid transporter av bränle och avfall skulle också blir lokal till olycksplatsen. Detta i kombination med att kärnkraft har visat sig vara ett mycket effektivt sätt att ersätta fosila bränslen, som inte bara skapar global klimatpåverkan utan också direkt hälsopåverkan på omgivningen, tycker vi är ett tugnt vägande skäl för att acceptera denna sammhälsmässiga risk. Men det är en givetvis en subjektiv bedömning och vi tycker det är viktigt att peka ut det här är en negativ sida av kärnkraft som inte förnybara energislag delar.</p>
</section>
<section id="danger-4">

...
---
Radioaktivitet skrämmer de flesta av oss. Att kärnkraft kan leda till att radioaktiva ämnen sprids är också ett av de vanligaste motargumenten mot kärnkraft. Få av oss har dock en klar uppfattning om hur olika stråldoser i vår miljö förhåller sig till varandra. Eftersom vi inte kan uppfatta radioaktivitet genom våra sinnen är det svårt för oss att skapa oss en bild av hur stråldoserna från kärnkraft (både vid normal drift och olyckor) förhåller sig till de strålkällor vi utsätter oss för normalt och inte skräms av. För att illustrera detta har vi här lånat <a href="https://xkcd.com/radiation/">XKCDs sammanställning av olika stråldoser</a>.
<img class="img-responsive blog-img" src="{{ "/assets/img/fact-check/radiation-xkcd.png" | prepend: site.baseurl }}">
Detta diagram kan användas för att få en översiktlig känsla för hur olika stråldoser förhåller sig till varandra. Vi kan t.ex. se att stråldosen av att bo inom 8 mils radie från ett kärnkraftverk är likvärdig med den man får i sig av att äta ett par bananer per år. Inom 5 km radie beräknas det maximala tillskottet i årsdos vara under 20 µSv vilket vi kan se utgör halva den stråldos du får om du gör en flygresa från Sverige till Kanarieöarna. 

Vi tror att denna övergripande förståelse för olika stråldoser är nödvändig för att kunna ta rationella beslut när vi väger riskerna med kärnkraft mot riskerna med att globalt fortsätta att användanda fossila bränslen. 

Det borde vara relativt klart utifrån tillgänglig data över kärnkraft respektive fossila bränslen att för de senare så är både hälsoeffekterna och de miljö-effekterna långt allvarligare.  Trotts det ser vi exempel på hur länder som t.ex. Tyskland prioriterar utfasning av kärnkraftverk före utfasning av kol.

Samtidigt är det viktigt att peka på att det också finns en omvänd problematik. På de punkter där säkerhetsläget är oklart väljer många kärnkraftsförespråkare att säga att riskerna är iprincip obefintliga. Vilket ger en falsk bild och biddrar till en polarisering av debatten.

Om varken lyckokalkyler eller ej faktagrundad rädsla ska få vara med och styra vilka energislag som används i världen måste vi som debattörer i kärnkraftsfrågan ta vårt ansvar och vara försiktiga med att inte sprida vidare missvisande information om säkerhetsriskerna.

Vi vill här lyfta de exempel vi funnit där vi anser att Miljöpartiet idag inte tar det ansvaret. Men vi vill också belysa några exempel där säkerhetsläget är oklart och där vi ser att kärnkraftsmotståndare felaktigt sätter likhetstecken mellan minsta hittills påvisbara hälso/miljö-effekt och faktisk hälso-miljö effekt.
...
<ul>
	...
	<a class="page-scroll" href="#danger-2"><li><p><b class="fact-check-text">Hur är säkerheten vid våra svenska kärnkraftverk?</b><br> I de granskade publikationerna ges en svart bild av säkeherheten vid de svenska reaktorerna. Här ger vi våra argument till varför vi inte delar den bilden</p></li></a>
...
catastrophe: the worst effects are still to come</a>. I sin rapport kommer Greenpeace fram till den anmärkningsvärda siffran att tjernobylolyckan kommer orsaka 270 000 cancerfall varav 93 000 med dödlig utgång. Till skillnad från den sammanställning WHO gjort av forskningsläget bygger dock Greenpeace rapport på studier som <a href="http://www.nytimes.com/2013/11/08/opinion/a-report-on-chernobyl.html?_r=0" target="_blanc">ej genomgått peer-review förfarande</a>.</p>
<p>Vi tycker därför det är mycket positivt att publikationsförfattaren här väljer att använda sig av data från den rapport som WHO och svenska strålskyddsmyndigheten valt att ställa sig bakom. Men vi har två kommentarer vi vill göra till citatet ovan.</p>
<ul>
...
<p>Eftersom publikationen <a href="">Kärnkraft i klimatkrisens tidevarv</a> är tänkt att fungera som en faktabas för partimedlemmar i kärnkraftsfrågan hade vi gärna sett att man också gav en kort förklaring till varför man kan komma till så här totalt olika slutsatser om antalet orsakade cancerfall. I <a href="https://www.youtube.com/watch?v=TpC_cPlx16g">denna korta video</a> förklaras varför det är svårt att göra entydliga uppskattningar av antalet cancerfall som olyckan förväntas orsaka. Värt att notera här är att även om vi applicerar den mest konservativa modellen, den såkallade Linnear-Non-Threshold modellen, som gör antaget att även minimalt ökade stråldoser kommer orsaka ökade antal cancerfall, då kommer vi till slutsatsen att olyckan som mest kommer orsaka 17000-68000 dödliga cancerfall totalt, vilket alltså är långt under de siffror Greenpeace lyfter fram</p>
